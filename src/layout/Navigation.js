    ...
    <div className='navigation'>
      ...
      <nav>
        ...
        <div className='languageSelection'>
          <button
            className={language === 'pl' ? 'naviButton current' : 'naviButton'}
            value='pl'
            onClick={langHandler}
          >
            PL
          ...
          /{' '}
          <button
            className={language === 'en' ? 'naviButton current' : 'naviButton'}
            value='en'
            onClick={langHandler}
          >
            EN
        ...
        <ul className='naviList'>
          <li className='naviListElement' onClick={naviHandler}>
          ...
          <li className='naviListElement' onClick={naviHandler}>
            <ScrollIntoView selector='.projectSection'>
              <button className='naviListButton mdl-button mdl-js-button mdl-button--raised'>
                {portfolio}
              </button>
            </ScrollIntoView>
